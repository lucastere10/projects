...
with st.container():
    df = pd.read_csv('Streamlit Projects\project_superstore\data\superstore.csv',encoding='cp1252')
    states = json.load(open("Streamlit Projects\\project_superstore\\data\\us_states_data.json",'r'))
    #change to datetime
